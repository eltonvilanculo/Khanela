...
public class MainActivity extends AppCompatActivity {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        try {
                           ...
                           updateUserNotificaionId(currentUser.getNotificationId());
    ...
    private void updateDataBase(String id) {
        currentUser.setNotificationId(id);
        DatabaseReference database = FirebaseDatabase.getInstance().getReference(DatabaseHelper.USERS);
        database
                .child(FirebaseAuth.getInstance().getUid())
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Log.d(TAG, "sucesso a actualizar ");
                        } else {
                            Log.d(TAG, "Erro ao actulizar");
                        }
                    }
                });
    }

    void updateUserNotificaionId(final String notificationId) {
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
            ...
            public void onComplete(@NonNull Task<InstanceIdResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    } else updateDataBase(id);

                } else {
                    Log.d(TAG, "Nao apanhou o id da notificacao");
                }
